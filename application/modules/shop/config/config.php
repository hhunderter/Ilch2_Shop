...
/***   example entries   ***/
                ...
                INSERT INTO `[prefix]_shop_settings`
                    (`id`, `shopName`, `shopLogo`, `shopStreet`, `shopPlz`, `shopCity`, `shopTel`, `shopFax`, `shopMail`, `shopWeb`, `shopStNr`, `bankName`, `bankOwner`, `bankIBAN`, `bankBIC`, `invoiceTextTop`, `invoiceTextBottom`, `agb`, `fixTax`, `fixShippingCosts`, `fixShippingTime`, `paymentClientID`, `ifSampleData`)
                VALUES
                    (1, 
                    "ILCH Shop",
